...
# FIRST Click the apple icon in the upper left hand corner and check to see what MacOs you are running Sierra or High Sierra you
# SHOULD Upgrade to Big Sur! If not many of these applications won't install. 
# Go into your App Store and search for MacOs, download Big # Sur and start the installation process.
