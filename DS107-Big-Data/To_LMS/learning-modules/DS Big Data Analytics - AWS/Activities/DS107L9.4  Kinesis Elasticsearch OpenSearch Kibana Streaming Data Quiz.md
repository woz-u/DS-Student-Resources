...
- A real-estate website tracks a subset of data from consumers’ mobile devices and makes real-time property recommendations
...
- A solar power company has to maintain power throughput for its customers
- A media publisher streams billions of clickstream records from its online properties
- An online gaming company collects streaming data about player-game interactions
- **A retail company tracks inventory uploading data on an infrequent basis to a static website**
...
- Queries or processing that require real-time results
- **Queries or processing over a static data set**
- Queries or processing over a sliding time period or window
- Queries or processing over a growing data set
